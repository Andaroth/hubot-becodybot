...
# functions
  ...
  robot.hear /mail d'admin/i, (res) -> res.send table.mail.admin
  robot.hear /mail alex/i, (res) -> res.send table.mail.alex
  robot.hear /mail de alex/i, (res) -> res.send table.mail.alex
  robot.hear /mail d'alex/i, (res) -> res.send table.mail.alex
  robot.hear /mail emi/i, (res) -> res.send table.mail.emi
  robot.hear /mail de emi/i, (res) -> res.send table.mail.emi
  robot.hear /mail d'emi/i, (res) -> res.send table.mail.emi
  robot.hear /mail ber/i, (res) -> res.send table.mail.ber
  robot.hear /mail de ber/i, (res) -> res.send table.mail.ber
  robot.hear /mail ted/i, (res) -> res.send table.mail.ted
  robot.hear /mail de ted/i, (res) -> res.send table.mail.ted
  robot.hear /mail eric/i, (res) -> res.send table.mail.eric
  robot.hear /mail de eric/i, (res) -> res.send table.mail.eric
  robot.hear /mail d'eric/i, (res) -> res.send table.mail.eric
  robot.hear /mail de juan/i, (res) -> res.send table.mail.juan
  robot.hear /mail juan/i, (res) -> res.send table.mail.juan
  robot.hear /mail cedric/i, (res) -> res.send table.mail.cedric
  robot.hear /mail de cedric/i, (res) -> res.send table.mail.cedric
  robot.hear /mail cédric/i, (res) -> res.send table.mail.cedric
  robot.hear /mail de cédric/i, (res) -> res.send table.mail.cedric
  #social
  robot.hear /Merci Hubot/i, (res) -> res.send res.random table.uwelcome
  # late
  robot.hear /en retar/i, (res) -> res.send table.retar
  robot.hear /mon retar/i, (res) -> res.send table.retar
  # late in english
  robot.hear /m late/i, (res) -> res.send table.late
  robot.hear /ll be late/i, (res) -> res.send table.late
  robot.hear /I will be late/i, (res) -> res.send table.late
  #bxf
  robot.hear /bxf/i, (res) -> res.send table.mail.bxf
  robot.hear /bruxelles-formation/i, (res) -> res.send table.mail.bxf
  robot.hear /bruxelles formation/i, (res) -> res.send table.mail.bxf
  #repos
  robot.hear /repo veille/i, (res) -> res.send table.repo.veille
  robot.hear /repo de la veille/i, (res) -> res.send table.repo.veille
  robot.hear /repo axel/i, (res) -> res.send table.repo.axel
  robot.hear /repo d'axel/i, (res) -> res.send table.repo.axel
  robot.hear /repo de axel/i, (res) -> res.send table.repo.axel
  #badges
  robot.hear /badge claim/i, (res) -> res.send table.mail.claim
  #other
  robot.hear /wifi/, (res) -> res.send table.wifi
  robot.hear /spotify/, (res) -> res.send table.spotify
  robot.hear /joke/, (res) -> res.send res.random table.joke.out
  robot.hear /blague/, (res) -> res.send res.random table.joke.out
  robot.hear /meteo/i, (res) -> res.send table.meteo
  robot.hear /météo/i, (res) -> res.send table.meteo
  robot.hear /quel temps fait/i, (res) -> res.send table.meteo
